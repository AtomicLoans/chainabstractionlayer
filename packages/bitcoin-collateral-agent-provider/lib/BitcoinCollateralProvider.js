...
export default class BitcoinCollateralAgentProvider extends Provider {
  constructor (chain = { network: networks.bitcoin }) {
    super()
    this._network = chain.network
  }

  createRefundableCollateralScript (borrowerPubKey, lenderPubKey, agentPubKey, secretHashA2, secretHashB1, secretHashB2, loanExpiration, biddingExpiration) {
...
BitcoinCollateralAgentProvider.version = version
